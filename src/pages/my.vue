<template>
	<div class="my">
		<header class="header">
			...
			<div class="myInfo">
				<p>欢迎你! <span><!-- {{user.userName}} -->安東生</span></p>				
			</div>			
		</header>
		<section class="myPageCon">
			<div class="myOrder">
				<router-link :to="{name:'订单详情'}">
					<span>我的订单</span>
					<span class="arrow"><i class="arrowRight666"></i></span>
				</router-link>				
			</div>
		...
		<my-footer pageName="我的"></my-footer>
	</div>
</template>
<script >
		...
		.orderStatus{
			...
			li{
				...
				.getIcon{
					...
					width: 20px;
					height: 20px;
					background: url(../assets/img/shouhuo.png);
					background-size: cover;
				}
				.returnIcon{
					display: inline-block;
